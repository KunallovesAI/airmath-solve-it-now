...
export const solveEquation = (equation: string): SolutionResult => {
  try {
    // In a real app, we would have a more sophisticated solver here
    ...
    return {
      ...
      error: "This is too complex for AIRMATH. Try Wolfram Alpha."
    };
  }
};
